/* Generates packages/core/src/lib/emoji.ts from the curated dataset below —
   the single emoji source every client (web + mobile) imports via
   @agora/core. Edit DATA here, then run `node scripts/gen-emoji.js`. */
const fs = require("fs");
