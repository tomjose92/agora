/* Inline SVG icon set (Lucide outlines, https://lucide.dev — ISC license),
   vendored so the UI keeps working offline and inside the desktop shell.
   Normalized to the Pantheo admin style: 24x24 viewBox, stroke 1.8, round
   caps/joins, currentColor. Use icon(name) inside template HTML. */
...
/* Returns the SVG markup for a named icon; extra classes ("fill", "spin", …)
   ride on the svg element. Safe inside innerHTML template strings. */
